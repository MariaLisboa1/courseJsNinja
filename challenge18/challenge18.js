...
function replaceCpf(cpf) {
  return cleanCPF(cpf).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4');
}

console.log(replaceCpf('049-214 3421-1'));
console.log(replaceCpf('210.458.522-05'));
console.log(replaceCpf('735 500 794 - 22'));
console.log(replaceCpf('101.123-131x32'));
...
console.log( text.replace( /(<(\w+)>)([^<]+)(<\/\w+>)/g, '$1 O texto dentro da tag "$2" é $3 $4\n' ) );
