...
var person1 = new Person('Maria', 'Lisboa', 24);
var person2 = new Person('Tuan', 'Luis', 8);
var person3 = new Person('João', 'Henrique', 24);
...
console.log(`${person3.getFullName()} agora tem ${person3.addAge(4).getAge()} anos`);
