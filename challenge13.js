...
*/
var nordeste = ['Alagoas', 'Paraíba', 'Pernambuco', 'Bahia', 'Sergipe'];
...
var msg = 'todos os estados tem mais de 7 letras!';

var hasSevenLetters = brasil.every(function (state) {
	return state.length > 7
});

console.log(hasSevenLetters ? `Sim, ${smg}` : `Nem ${msg}`);
