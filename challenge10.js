...
function showErrorMessage(operator) {
  if(!isOperatorValid(operator)) return `Operação ${operator} não permitida!`;
...
if (subtraction) {
  console.log(showOperationMessage(operationSignal, n1, n2));
...
operationSignal = '**';
var operatorInvalid = calculator(operationSignal);

if (operatorInvalid) {
  console.log(showOperationMessage(operationSignal, n1, n2));
  console.log(operatorInvalid);
} else {
  console.log(showErrorMessage(operationSignal));
}
